...
public class CategoryElementSimple implements IHierarchyElement {
	private ConfigCategory category;
	private ICfgHierarchyHandler handler;
	private ICfgTooltipHandler tooltip;
	private boolean isRoot;
	
	public CategoryElementSimple(ConfigCategory category, ICfgHierarchyHandler handler, ICfgTooltipHandler tooltip) {
	...
	public CategoryElementSimple(ConfigCategory category, ICfgHierarchyHandler handler, ICfgTooltipHandler tooltip, boolean isRoot) {
		this.category = category;
		this.handler = handler;
		this.tooltip = tooltip;
		this.isRoot = isRoot;
	...
	public String setupBackground(boolean isHorizontal, IRenderer renderer) {
		return this.isRoot? null : handler.setupBackground(isHorizontal, renderer);
	}
