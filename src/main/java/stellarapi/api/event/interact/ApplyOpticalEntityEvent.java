...
/**
 * Fired when it needs to check if certain entity is optical simulator, as view
 * scope or optical filter.
 * <p>
 * Especially, when entity ridden by the player is changed.
 * <p>
 * (Note that entity given by this event can be different from current entity
 * ridden by the player. The riding entity from this event is not null.)
 * <p>
