...
/**
 * Fired to construct the set of celestial collections.
 * <p>
 * Celestial collections and light sources should be registered here.
 * <p>
 * Note that both should be registered every time when this event is called, and
 * any modification/wrapper should be applied in this event.
 * <p>
 * 
 * This event is <code>@Cancelable</code>, and canceling this event will force
 * the celestial set not to be constructed now.
 */
@Cancelable
public class ConstructCelestialsEvent extends PerWorldEvent {
	...
	/**
	 * Getter for light sources. Register the effectors here. (The objects
