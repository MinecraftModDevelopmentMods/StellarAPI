...
public class WorldProviderExample extends WorldProvider {
	...
	public float getSunlightFactor(float partialTicks) {
		return celestialHelper.getSunlightFactor(partialTicks);
	}
    ...
    {
        float f2 = 1.0F - (this.getSunlightFactor(par1)-0.3f);
	...
	public float getSunBrightnessFactor(float par1) {
        float f1 = 1.0F - this.getSunlightFactor(par1);
        ...
        if (f3 >= f4 - f2 && f3 <= f4 + f2)
        {
            ...
            for(int i = 0; i < 4; i++)
            	this.colorsSunriseSunset[i] = this.colorsSunriseSunset[i]
            			* celestialHelper.calculateSunriseSunsetFactor(p_76560_2_)
            			* celestialHelper.getDispersionFactor(p_76560_2_);
    ...
    {
        float f2 = this.getSunlightFactor(p_76562_2_) * celestialHelper.getDispersionFactor(p_76562_2_);
    ...
    {
        float f2 = this.getSunlightFactor(partialTicks) * celestialHelper.getDispersionFactor(partialTicks);
        ...
        f2 += this.getMixedBrightnessOn(cameraEntity.posX, cameraEntity.posY, cameraEntity.posZ, i, j, k)
        		* celestialHelper.getDispersionFactor(partialTicks) * celestialHelper.getLightPollutionFactor(partialTicks);
    ...
    {
        float f2 = 1.0F - (this.getSunlightFactor(par1)*celestialHelper.getDispersionFactor(par1)-0.25f);
