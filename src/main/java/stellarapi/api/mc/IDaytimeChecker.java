 ...
 * Mostly co-implemented with the coordinate provider. <p>
 * Note that daytime checker which is registered later will have higher priority.
 * */
public interface IDaytimeChecker {
	
	/**
	 * Checks if this daytime checker will work on certain case or not. <p>
	 * Should return false when {@link #timeForCertainDescriptor(World, CelestialLightSources, ICelestialCoordinate, EnumDaytimeDescriptor, long)}}
	 ...
	 * @param coordinate the coordinate (only dependent to the world)
	 * @param descriptor the daytime descriptor (only dependent to the world)
	 ...
	 * @throws ImpossibleDescriptorException if there is no time for the certain descriptor
	 * */
