...
/**
 * Interface for Optical item as scope.
 * <p>
 ...
 * {@link stellarapi.api.event.UpdateScopeEvent} to identify your scope item.
 * <p>
 * Note that this item will be specified as same on held item when the type and
 * damage is same.
 */
