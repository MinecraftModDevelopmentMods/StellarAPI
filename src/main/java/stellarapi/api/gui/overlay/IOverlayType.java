...
/**
 * Certain overlay type. Note that the Right Center part is already reserved by
 * the position handling overlay.
 */
public interface IOverlayType<Element extends IOverlayElement<Settings>, Settings extends PerOverlaySettings> {
	...
	/**
	 * Gets the name of certain overlay element, which will be the category name
