...
public interface IRollableFluentController extends IElementController {
	...
	/**
	 * Inverts roll state when actual coordinate decreases. Setting this to true
	 * ensures that roll state is 0 on rolled and 1 on unrolled, while false
	 * ensures that roll state is dependent to the coordinate.
	 */
