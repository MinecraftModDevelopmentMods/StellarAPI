...
public class CombinedLoadingScreenRenderer extends LoadingScreenRenderer implements ICombinedProgressUpdate {
	...
	public void resetProgressAndMessage(String p_73721_1_) {
		if (delegates.size() == 1)
			...
			delegates.get(vanillaKey).resetProgressAndMessage(p_73721_1_);
	}
	...
	public void displaySavingString(String p_73719_1_) {
		if (delegates.size() == 1)
			...
			delegates.get(vanillaKey).displaySavingString(p_73719_1_);
	}
	...
	public void displayLoadingString(String p_73720_1_) {
		if (delegates.size() == 1)
			...
			delegates.get(vanillaKey).displayLoadingString(p_73720_1_);
	}
	...
	public void setLoadingProgress(int p_73718_1_) {
		if (delegates.size() == 1)
			...
			delegates.get(vanillaKey).setLoadingProgress(p_73718_1_);
	}
	...
	private class LoadingDelegate extends LoadingScreenRenderer {
		...
		public void displayString(String p_73722_1_) {
			...
			if (OpenGlHelper.isFramebufferEnabled()) {
				...
				GlStateManager.ortho(0.0D, (double) (scaledResolution.getScaledWidth() * i),
						(double) (scaledResolution.getScaledHeight() * i), 0.0D, 100.0D, 300.0D);
			} else {
